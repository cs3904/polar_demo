...
"""
Save: Mono12 to PNG
	This example demonstrates saving Mono12 buffer data
	retrieved by the camera to PNG. This includes, configuring
	camera nodes, getting and converting camera buffer to numpy
	array and saving the array using PIL.
"""
