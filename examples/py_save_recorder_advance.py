...
Save Recorder: Advanced
	...
	to save videos with max fps and custom video name from
	image buffer data. This includes, configuring and initializing
	save recorder, setting stream and device nodes to maximize
	fps and minimize frame drops, getting and appending buffers
	to the recorder, and saving the video.
"""
...
def example_entry_point():
	...
	demonstrates Save Recorder: Advanced
	 ...
	 (3) Create a recorder object and configure its width, height,
	 	acquisition frame rate and output video name
