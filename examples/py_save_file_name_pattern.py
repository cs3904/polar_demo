...
if __name__ == '__main__':
	...
	# here you can set the pixel format
	...
	# getting hour minute and time from args
	# args = sys.argv[1:]
	# hour = int(args[1])
	# minute = int(args[2])
	# second = int(args[3])
	...
	# thread1 = Thread(target = set_alarm, args = (hour, minute, second))
	# time.sleep(1)
	# thread2 = Thread(target = take_images(), args = ())
